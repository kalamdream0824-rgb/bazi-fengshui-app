...
const NAYIN_WUXING: Record<string, WuxingKey> = {
  海中金: 'jin', 剑锋金: 'jin', 白蜡金: 'jin', 沙中金: 'jin', 金箔金: 'jin', 钗钏金: 'jin',
  炉中火: 'huo', 山头火: 'huo', 霹雳火: 'huo', 山下火: 'huo', 覆灯火: 'huo', 天上火: 'huo',
  大林木: 'mu', 杨柳木: 'mu', 松柏木: 'mu', 平地木: 'mu', 桑柘木: 'mu', 石榴木: 'mu',
  路旁土: 'tu', 城头土: 'tu', 屋上土: 'tu', 壁上土: 'tu', 大驿土: 'tu', 沙中土: 'tu',
  涧下水: 'shui', 泉中水: 'shui', 长流水: 'shui', 天河水: 'shui', 大溪水: 'shui', 大海水: 'shui',
}
