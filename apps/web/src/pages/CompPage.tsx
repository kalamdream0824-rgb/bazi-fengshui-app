        ...
        <>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, margin: '4px 14px 12px' }}>
            ...
            <div className="card" style={{ margin: 0, textAlign: 'center', padding: '12px 8px' }}>
              ...
              {personB ? (
                <PillarsRow result={personB} color="var(--water)" />
              ) : (
          ...
          <Card>
            ...
            <div style={{ padding: '0 16px 14px' }}>
              <Button
                block
                onClick={() =>
                  bDatetime && mutation.mutate({ gender: bGender, solarDateTime: bDatetime, trueSolarTime: false })
                }
          ...
          {comp && personB && (
            <>
              <div className="hero" style={{ textAlign: 'center', padding: 16 }}>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: 38, fontWeight: 700, lineHeight: 1 }}>
                  {comp.score}
                </div>
              ...
              <Card>
                ...
                <div style={{ padding: '0 16px 14px' }}>
                  <table style={{ width: '100%', fontSize: 12, borderCollapse: 'collapse' }}>
                    <tbody>
                      <tr>
                        <td style={{ border: '1px solid var(--line)', padding: '7px 2px', color: 'var(--red)' }}>
                          甲方
                        </td>
                        {WUXING_KEYS.map((k) => (
                          <td
                            key={k}
                            style={{ border: '1px solid var(--line)', padding: '7px 2px', textAlign: 'center' }}
                          >
                            {personA.wuXing[k]}
                          </td>
                        ))}
                      ...
                      <tr>
                        <td style={{ border: '1px solid var(--line)', padding: '7px 2px', color: 'var(--water)' }}>
                          乙方
                        </td>
                        {WUXING_KEYS.map((k) => (
                          <td
                      ...
                      <tr>
                        <td style={{ border: '1px solid var(--line)', padding: '7px 2px', background: '#faf5e8' }}>
                          五行
                        </td>
                        {WUXING_KEYS.map((k) => (
                          <td
              ...
              <Card>
                ...
                <div className="row">
                  ...
                  <span
                    style={{
                      color: comp.shengXiaoRelation === '六合' ? 'var(--jade)' : 'var(--ink-3)',
                      fontWeight: 600,
                      fontSize: 12,
                    }}
                  >
                ...
                <div className="row">
                  ...
                  <span
                    style={{
                      color: comp.dayMasterRelation === '相克' ? 'var(--red)' : 'var(--jade)',
                      fontWeight: 600,
                      fontSize: 12,
                    }}
                  >
                ...
                <div className="row">
                  ...
                  <span
                    style={{
                      color: comp.nayinRelation === '相克' ? 'var(--red)' : 'var(--jade)',
                      fontWeight: 600,
                      fontSize: 12,
                    }}
                  >
                ...
                <div className="row">
                  ...
                  <span
                    style={{
                      color: comp.spousePalaceRelation === '六冲' ? 'var(--red)' : 'var(--jade)',
                      fontWeight: 600,
                      fontSize: 12,
                    }}
                  >
                    {personA.pillars.day.zhi} · {personB.pillars.day.zhi}{' '}
                    {comp.spousePalaceRelation === '—' ? '无特殊' : comp.spousePalaceRelation}
                  </span>
                </div>
                <div className="row">
                  ...
                  <span
                    style={{
                      color: comp.yearRelation === '六冲' ? 'var(--red)' : 'var(--jade)',
                      fontWeight: 600,
                      fontSize: 12,
                    }}
                  >
                    {comp.yearRelation === '—' && !comp.yearGanHe
                      ? '无特殊'
                      : `${comp.yearRelation === '—' ? '' : comp.yearRelation}${comp.yearGanHe ? '·年干五合' : ''}`}
                  </span>
                </div>
                {comp.tips.map((tip) => (
              ...
              <ButtonRow>
                <Button variant="primary" onClick={() => toast('合婚报告生成中…（示例）')}>
                  生成合婚报告
                </Button>
