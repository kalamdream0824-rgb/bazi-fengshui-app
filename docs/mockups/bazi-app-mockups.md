...
| 3 | 基本排盘 | 命主信息卡、四柱表（主星/天干/地支/藏干/纳音/星运/神煞）、五行占比、**人话解读卡（总览+分块）**、基本/专业页签 | 页签切换、表内点击弹释义笺纸、解读块折叠 | ✅ M0.5（神煞行占位）+ 解读版评审中 |
| 4 | 专业细盘 | 大运列表（当前高亮）、流年解读、十神分布、**各页签人话解读** | 大运/流年/十神/神煞页签切换、解读块折叠 | ✅ M0.8（神煞占位）+ 解读版评审中 |
