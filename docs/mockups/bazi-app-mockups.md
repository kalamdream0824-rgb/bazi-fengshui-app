...
| # | 模块 | 核心内容 | 关键交互 |
|---|---|---|---|
| 1 | 首页 | 今日宜忌（今日/明日）、快捷功能 4 宫格、最近排盘 | 今日/明日切换、宫格跳转、底部导航 |
| 2 | 排盘输入 | 姓名、性别（乾/坤）、公历生日、出生时间、出生地、真太阳时开关 | 性别分段选择、开关、开始排盘 → 基本排盘 |
| 3 | 基本排盘 | 命主信息卡、四柱表（主星/天干/地支/藏干/纳音/星运/神煞）、五行占比、基本/专业页签 | 页签切换、表内点击弹释义笺纸 |
| 4 | 专业细盘 | 大运列表（当前高亮）、流年解读、十神分布 | 大运/流年/十神页签切换 |
| 5 | 八字合婚 | 双方四柱并排、婚配指数、五行互补表、冲合分析 | 生成合婚报告（占位 toast） |
| 6 | 每日运势 | 当日干支、星级、宜忌、幸运色/方位/贵人、注意事项 | 分享（占位 toast） |
| 7 | 命书报告 | 命书封面、目录（壹-伍）、样张预览、定价、导出 | 导出 PDF / 分享 / 返回 |
| 8 | 我的 | 我的命盘、会员入口、我的命书、历史记录、设置（真太阳时/神煞开关） | 开关切换、条目跳转 |
...
- 全部"示例"数据需接入 lunar-javascript 真实输出（神煞、星运、流年解读、婚配指数、运势星级）。
- 择日、分享、历史记录、会员开通、设置页为占位功能。
- 命书定价（¥9.9）、会员权益与定价待定。
- 微信小程序适配与合规过审策略（类目、文案词表）待专项评估。
- GitHub 仓库推送待用户完成授权后执行。
